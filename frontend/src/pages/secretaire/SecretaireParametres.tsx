...
export default function SecretaireParametres() {
    const { user } = useAuth();
                ...
                <div className="mb-4">
                    ...
                    <div className="d-flex align-items-center justify-content-between p-3 border rounded-3 mb-3" style={{ background: "#FAFAFA" }}>
                        <div>
                            ...
                            <div className="text-muted small">Mises à jour des dossiers et rendez-vous.</div>
                        </div>
                    ...
                    <div className="d-flex align-items-center justify-content-between p-3 border rounded-3" style={{ background: "#FAFAFA" }}>
                        <div>
                            ...
                            <div className="text-muted small">Alertes d'urgence.</div>
                        </div>
                        <div className="form-check form-switch custom-switch">
                            <input 
                                className="form-check-input" 
